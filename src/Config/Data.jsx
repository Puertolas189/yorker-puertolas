...
export const data = [
  {
    ...
    descripcion:
      "Crema facial con Argireline + Leuphasyl + Rosa Mosqueta Liposomada para uso de día. Apta para todo tipo de piel.",
    accion:
      "Acción: Crema con componentes específicos para darle a la piel un aspecto saludable.",
    modouso:
      "Modo de uso: Limpiar el rostro, cuello y escote para luego aplicar la crema, realizando masajes de manera circular y ascendente del centro hacia arriba, complementando con suaves masajes de tecleo con las yemas de los dedos.",
    horario: "Cremas de uso diario, para cualquier momento del día!",
    quienes:
      "Es un producto para TODO TIPO DE PIEL, grasa, mixta, seca, sensible, con arrugas, sin arrugas, lo que se busca es el REJUVENECIMIENTO CELULAR.",
  },
  {
    id: 2,
    categoria: 1,
